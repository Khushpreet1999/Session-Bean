...
import MortgageCalculator.MortgageRemote;
...
@EJB
MortgageRemote mrtgageCalculate;
/**
...
out.println("<h1>Servlet calculate at </h1>"+mrtgageCalculate.CalculateMortgage(amount, interest, year, month));
